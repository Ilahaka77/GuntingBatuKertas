...
function janken(tangan){
    ...
    switch (jariKen) {
        case 0:
            ken.style.backgroundImage = "url(assets/img/ken-batu.png)";
            break;
        case 1:
            ken.style.backgroundImage = "url(assets/img/ken-gunting.png)";
            break;
        default:
            ken.style.backgroundImage = "url(assets/img/ken-kertas.png)";
            break;
    }
